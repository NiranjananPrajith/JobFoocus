      ...
      >
        <div className="flex items-start gap-3 mb-4">
          <div
            ...
            aria-hidden="true"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#cc3a05" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M12 9v4" />
              <path d="M12 17h.01" />
    ...
    <div>
      ...
      <div className="h-1.5 rounded-full bg-canvas border border-hairline-soft overflow-hidden">
        <div
          ...
          style={{
            width: `${pct}%`,
            backgroundColor: highlight ? '#fa520f' : '#888888',
          }}
        />
      </div>
    </div>
