...
export default function ApplicationCard({
  ...
  return (
    <div
      className="bg-surface rounded-xl border border-hairline-soft overflow-visible transition-all duration-200 hover:shadow-[0_4px_20px_rgba(0,0,0,0.08)] hover:border-hairline-strong cursor-pointer"
        ...
        <div className="flex-1 min-w-0 overflow-visible">
          <div className="flex items-start justify-between gap-3 px-4 pt-4 pb-2">
            <div className="flex-1 min-w-0">
              <h3 className="text-[16px] font-semibold text-ink leading-tight truncate hover:text-primary transition-colors">
                {company}
              </h3>
